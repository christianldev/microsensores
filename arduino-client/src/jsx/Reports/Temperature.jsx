...
const RevenueChart = loadable(() =>
	pMinDelay(
		import('../components/Karciz/EventPage/RevenueChart'),
		1000
	)
);
const TicketChart = loadable(() =>
	pMinDelay(
		import('../components/Karciz/EventPage/TicketChart'),
		1000
	)
);
const SellingApexChart = loadable(() =>
	pMinDelay(
		import(
			'../components/Karciz/EventPage/SellingApexChart'
		),
		1000
	)
);
...
const eventTableData = [
	{
		...
		cname: 'Elisabeth Queen',
		ticket: '4 Pcs',
		statusblog: 'NO',
	},
	{
		id: '#0012452',
		date: '05/08/2020 11:21 AM',
		cname: 'Lilibet Queen',
		ticket: '5 Pcs',
		statusblog: 'NO',
	},
	{
		id: '#0012453',
		date: '07/08/2020 12:15 AM',
		cname: 'Aquitaine Queen',
		ticket: '6 Pcs',
		statusblog: 'YES',
	},
	{
		id: '#0012454',
		date: '08/08/2020 10:18 AM',
		cname: 'Hainault Queen',
		ticket: '8 Pcs',
		statusblog: 'NO',
	},
	{
		id: '#0012455',
		date: '09/08/2020 11:23 AM',
		cname: 'Anne Queen',
		ticket: '9 Pcs',
		statusblog: 'NO',
	},
	{
		id: '#0012456',
		date: '09/08/2020 12:34 AM',
		cname: 'Victoria Queen',
		ticket: '2 Pcs',
		statusblog: 'Yes',
	},
];
							...
							<div className="card-body">
								<div className="media d-md-flex d-block border-bottom pb-sm-4 pb-2 mb-4 text-md-left text-center">
									<img
										...
										alt=""
										width="280"
										className="rounded me-0 me-md-4 mb-2 mb-md-0"
									/>
										...
										<div className="d-md-flex d-block justify-content-between">
											...
											<Dropdown>
												<Dropdown.Toggle
													variant=""
													as="div"
													className="custom-dropdown mb-0 d-md-block d-none i-false">
													<svg
														width="24"
														height="24"
														viewBox="0 0 24 24"
								...
								<div className="row">
									<div className="col-lg-3 col-md-6 col-xxl-6 mb-3">
										<div className="media bgl-primary p-3 rounded align-items-center">
											...
											<div className="media-body">
												<span className="fs-12 d-block mb-1 text-primary">
													Ticket Price
												</span>
												<span className="fs-18 text-black">
													$124,00
												</span>
											</div>
										</div>
									...
									<div className="col-lg-5 col-md-12 col-xxl-12">
										<div className="media bgl-primary p-3 rounded align-items-center">
											<svg
												...
												<g clipPath="">
													<path
														d="M27.5711 13.4286C27.5711 22.4286 15.9997 30.1428 15.9997 30.1428C15.9997 30.1428 4.42822 22.4286 4.42822 13.4286C4.42822 10.3596 5.64735 7.41639 7.81742 5.24632C9.98748 3.07626 12.9307 1.85713 15.9997 1.85713C19.0686 1.85713 22.0118 3.07626 24.1819 5.24632C26.3519 7.41639 27.5711 10.3596 27.5711 13.4286Z"
														stroke="var(--primary)"
														strokeWidth="3"
														strokeLinecap="round"
						...
						<div className="card overflow-hidden bg-image bg-danger">
							<div className="card-header  border-0">
								<div>
									...
									<h3 className="mb-0 fs-24 font-w600 text-white"></h3>
								</div>
							</div>
						</div>
					</div>
