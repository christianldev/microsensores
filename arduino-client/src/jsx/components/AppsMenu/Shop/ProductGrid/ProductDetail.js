												...
												<div className="filtaring-area me-3">
													<div className="size-filter">
														...
														<div className="d-flex select-size mb-2" data-toggle="buttons">
															...
															<label className="btn btn-outline-primary sharp sharp-lg me-2" htmlhtmlFor="btnradio1">XS</label>
															<input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
															<label className="btn btn-outline-primary sharp sharp-lg mx-1" htmlhtmlFor="btnradio2">SM</label>
															<input type="radio" className="btn-check" name="btnradio" id="btnradio3" />
															<label className="btn btn-outline-primary sharp sharp-lg mx-1" htmlhtmlFor="btnradio3">MD</label>

															<input type="radio" className="btn-check" name="btnradio" id="btnradio4" />
															<label className="btn btn-outline-primary sharp sharp-lg mx-1" htmlhtmlFor="btnradio4">LG</label>

															<input type="radio" className="btn-check" name="btnradio" id="btnradio5" />
															<label className="btn btn-outline-primary sharp sharp-lg mx-1" htmlhtmlFor="btnradio5">XL</label>
														</div>
													</div>
												</div>
												{/*Quantity start*/}
